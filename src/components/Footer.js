...
import {BsInstagram,BsTwitter,BsFacebook,BsPinterest,BsYoutube} from 'react-icons/bs';
      ...
      <div className="container-xxl">
        <div className="row">
          ...
          <div>
            ...
            Demo Store<br/>
            No. 2259 Freedom, New York, 11111<br/>
            United States
            </address>
            <a href="tel:+91 323232323" className='mt-3 d-block mb-1 text-white'>
            +91 323232323
            </a>
            <a href="mailto:mdsamarasinghe53@gmail.com" className='mt-2 d-block mb-0 text-white'>
